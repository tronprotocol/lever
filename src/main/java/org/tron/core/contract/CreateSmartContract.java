package org.tron.core.contract;
...
public class CreateSmartContract {
  ...
  public static Contract.CreateSmartContract createContractDeployContract(String contractName,
    ...
    builder.setOriginAddress(address);
    builder.setAbi(abi);
    ...
    return Contract.CreateSmartContract.newBuilder().setOwnerAddress(address).
  ...
  public static Contract.TriggerSmartContract triggerCallContract(ByteString address,
      ByteString contractAddress,
      long callValue, ByteString data) {
