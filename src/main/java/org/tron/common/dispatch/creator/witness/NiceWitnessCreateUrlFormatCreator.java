...
//        .build();
//    Protocol.Transaction createAccountTransaction = client.createTransaction(createAccountContract);
//
//    createAccountTransaction = TransactionUtils.signTransaction(createAccountTransaction, ECKey.fromPrivate(ByteArray.fromHexString(privateKey)));
//
//    boolean b = client.broadcastTransaction(createAccountTransaction);
//
...
//      transaction = TransactionUtils.signTransaction(transaction, ECKey.fromPrivate(ecKey.getPrivKeyBytes()));
//    }
