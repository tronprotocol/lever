...
public class TriggerTwoContractDeleteCreator extends AbstractTransferTransactionCreator implements
    ...
    try {
      contract = triggerCallContract(ownerAddress.toByteArray(), Base58
          ...
          org.bouncycastle.util.encoders.Hex
              .decode(AbiUtil.parseMethod("callDeleteKey(uint256)", String.format(
                  "\"%d\"",
